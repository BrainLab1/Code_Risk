...
save_dir = 'D:\Shared\Report 17\Multinomial logostic regression classifier\';
...
%     sesTrialPower1{ses} = thisSesChannels1;
%     sesTrialPower2{ses} = thisSesChannels2;
...
for ses = 1:length(sesFileNames) 
    ...
    % convert [EV Var] grouping to EV groupign
    thisSesChannels1 = cellfun(@(x)  cellfun(@(y) cell2mat(y), mat2cell(x, [ones(1,9)], ones(1,size(thisSesChannels1{1,1},2))), 'UniformOutput', 0) , thisSesChannels1, 'UniformOutput', 0);
    thisSesChannels2 = cellfun(@(x)  cellfun(@(y) cell2mat(y), mat2cell(x, [ones(1,9)], ones(1,size(thisSesChannels2{1,1},2))), 'UniformOutput', 0) , thisSesChannels2, 'UniformOutput', 0);
...
%     thisSesChannels1 = thisSesChannels2;
