...
tmp_iniCfg                 = [];
tmp_iniCfg.headerformat    = 'blackrock_nsx';
tmp_iniCfg.data_dir        = [main_folder data_folder data_dir];
tmp_iniCfg.trialfun        = 'fieldtrip_trialfun_RiskBhv'; % string with function name, see below (default = 'ft_trialfun_general')
tmp_iniCfg.trialdef.pre    = 1; % time in seconds; this only indicates absolut value, do not use '-'
tmp_iniCfg.trialdef.post   = 1; % time in seconds
